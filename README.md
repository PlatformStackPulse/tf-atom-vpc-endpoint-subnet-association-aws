...
[![CI](https://github.com/PlatformStackPulse/tf-atom-vpc-endpoint-subnet-association-aws/actions/workflows/ci.yml/badge.svg)](https://github.com/PlatformStackPulse/tf-atom-vpc-endpoint-subnet-association-aws/actions/workflows/ci.yml)
[![Release](https://github.com/PlatformStackPulse/tf-atom-vpc-endpoint-subnet-association-aws/actions/workflows/auto-release.yml/badge.svg)](https://github.com/PlatformStackPulse/tf-atom-vpc-endpoint-subnet-association-aws/actions/workflows/auto-release.yml)
[![CodeQL](https://github.com/PlatformStackPulse/tf-atom-vpc-endpoint-subnet-association-aws/actions/workflows/codeql.yml/badge.svg)](https://github.com/PlatformStackPulse/tf-atom-vpc-endpoint-subnet-association-aws/actions/workflows/codeql.yml)
![Terraform](https://img.shields.io/badge/terraform-%3E%3D1.6.0-blueviolet)
[![Latest Release](https://img.shields.io/github/v/release/PlatformStackPulse/tf-atom-vpc-endpoint-subnet-association-aws)](https://github.com/PlatformStackPulse/tf-atom-vpc-endpoint-subnet-association-aws/releases)
